...
def process_timestep(
    ti, caseToProcess, folder, tsnap, GridsPerR, rmin, rmax, zmin, zmax, lw
):
    t = tsnap * ti
...
def main():
    ...
    parser.add_argument(
        "--CPUs", type=int, default=mp.cpu_count(), help="Number of CPUs to use"
    )
    parser.add_argument(
        "--nGFS", type=int, default=4000, help="Number of restart files to process"
    )
    parser.add_argument(
        "--GridsPerR", type=int, default=64, help="Number of grids per R"
    )
    ...
    parser.add_argument(
        "--caseToProcess",
        type=str,
        default="../testCases/die-Swell_Viscoelastic",
        help="Case to process",
    )
    parser.add_argument(
        "--folderToSave", type=str, default="Video", help="Folder to save"
    )
